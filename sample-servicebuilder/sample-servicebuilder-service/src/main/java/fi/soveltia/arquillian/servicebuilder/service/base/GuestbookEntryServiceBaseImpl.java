...
import fi.soveltia.arquillian.servicebuilder.service.GuestbookEntryService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link fi.soveltia.arquillian.servicebuilder.service.impl.GuestbookEntryServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class GuestbookEntryServiceBaseImpl extends BaseServiceImpl
	implements GuestbookEntryService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link fi.soveltia.arquillian.servicebuilder.service.GuestbookEntryServiceUtil} to access the guestbook entry remote service.
	 */
	 ...
	 */
	public fi.soveltia.arquillian.servicebuilder.service.GuestbookEntryLocalService getGuestbookEntryLocalService() {
	...
	public void setGuestbookEntryLocalService(
		fi.soveltia.arquillian.servicebuilder.service.GuestbookEntryLocalService guestbookEntryLocalService) {
		this.guestbookEntryLocalService = guestbookEntryLocalService;
	}

	/**
	 * Returns the guestbook entry remote service.
	 *
	 * @return the guestbook entry remote service
	 */
	public GuestbookEntryService getGuestbookEntryService() {
		return guestbookEntryService;
	}

	/**
	 * Sets the guestbook entry remote service.
	 *
	 * @param guestbookEntryService the guestbook entry remote service
	 */
	public void setGuestbookEntryService(
	...
	@BeanReference(type = fi.soveltia.arquillian.servicebuilder.service.GuestbookEntryLocalService.class)
	protected fi.soveltia.arquillian.servicebuilder.service.GuestbookEntryLocalService guestbookEntryLocalService;
	@BeanReference(type = GuestbookEntryService.class)
